...
const Header: React.FC<{
  ...
  return (
    <header
      className={`flex justify-between items-center max-w-[760px] m-auto flex-col sm:flex-row text-center   ${
        isLight ? "text-[#0C0E16] bg-white" : "text-white bg-[#141625]"
      }`}
    >
        ...
        <div>
          ...
          {isFilterOpen && (
            <div
              ...
              }  w-[192px] h-[155px] mt-6 shadow-lg rounded-md flex flex-col`}
            >
              <label
