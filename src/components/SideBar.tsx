...
export default function SideBar() {
  return (
    <div className='w-full h-[72px] fixed top-0 z-50 flex  justify-between bg-[#373B53] tablet:h-[80px] desktop:flex-col desktop:h-screen desktop:w-[103px] desktop:rounded-r-[20px] '>
